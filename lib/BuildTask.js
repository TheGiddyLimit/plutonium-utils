...
const doBuild = async (opts) => {
	const {dir, version, additionalFiles, additionalDirectories, isQuiet, persistentStorage} = opts;
	const dirsModuleIncludeSet = opts.dirsModuleInclude != null ? new Set(opts.dirsModuleInclude) : null;
	const dirsModuleIgnoreSet = new Set([...opts.dirsModuleIgnore || [], "scss"]);
